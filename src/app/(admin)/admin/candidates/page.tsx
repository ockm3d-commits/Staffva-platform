...
const STATUS_BADGE: Record<string, { label: string; color: string }> = {
  ...
  pending_speaking_review: { label: "Pending Admin Review", color: "bg-amber-100 text-amber-700" },
  pending_2nd_interview: { label: "Pending Recruiter Interview", color: "bg-amber-100 text-amber-700" },
  pending_review: { label: "Pending Admin Review", color: "bg-amber-100 text-amber-700" },
