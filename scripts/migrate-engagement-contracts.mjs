/**
 * Migration: engagement_contracts table
 * Run: node scripts/migrate-engagement-contracts.mjs
 */
...
async function runMigration() {
  console.log("\n🔧 Running engagement_contracts migration...\n");

  const sql = readFileSync("supabase/migrations/00023_engagement_contracts.sql", "utf-8");
  ...
  console.log("✅ Migration complete — engagement_contracts table created");
  ...
  if (checkErr) {
    console.log(`❌ Verification failed: ${checkErr.message}`);
  } else {
    console.log("✅ Table verified — engagement_contracts accessible");
  }
